...
module h5.application {
    ...
    export class AppController {
        ...
        */
        ...
        /**
        * Initialize the LBLCUS Master module
        */
        private initLBLCUSModule() {
        ...
        */
        private initScopeFunctions() {
            ...
            this.scope.LBLCUSModule.loadLBLCUSRecordModule = (fieldName, rowEntity) => { this.displayDetailScreen(fieldName, rowEntity); }
        }
        ...
        */
        private initUIGridsOnRegisterApi() {
            this.scope.LBLCUSModule.LBLCUSListGrid.onRegisterApi = (gridApi) => {
                this.gridService.adjustGridHeight("LBLCUSListGrid", this.scope.LBLCUSModule.LBLCUSListGrid.data.length, 500);
                gridApi.core.on.renderingComplete(this.scope, (handler: any) => { this.gridService.restoreGridState("LBLCUSListGrid", gridApi); });
                gridApi.core.on.sortChanged(this.scope, (handler: any) => { this.gridService.saveGridState("LBLCUSListGrid", gridApi); });
                gridApi.core.on.columnVisibilityChanged(this.scope, (handler: any) => { this.gridService.saveGridState("LBLCUSListGrid", gridApi); });
                gridApi.core.on.filterChanged(this.scope, (handler: any) => { this.gridService.saveGridState("LBLCUSListGrid", gridApi); });
                gridApi.colMovable.on.columnPositionChanged(this.scope, (handler: any) => { this.gridService.saveGridState("LBLCUSListGrid", gridApi); });
                gridApi.colResizable.on.columnSizeChanged(this.scope, (handler: any) => { this.gridService.saveGridState("LBLCUSListGrid", gridApi); });
                ...
                gridApi.selection.on.rowSelectionChanged(this.scope, (row: any) => {
                    this.gridService.saveGridState("LBLCUSListGrid", gridApi);
                    this.LBLCUSListRowSelected(row);
                });
        ...
        */
        private loadApplicationData() {
            let categories = ['globalSelection', 'LBLCUSModule', 'customerMasterModule', 'LBLCUSModule'];
        ...
        private clearData(categories: string[]) {
            categories.forEach((category) => {
                ...
                if (category == "LBLCUSModule") {
                    ...
                    this.scope.LBLCUSModule.LBLCUSList = [];
                }
            });
        }
        ...
        */
        private refreshTransactionStatus() {
            ...
            switch (this.scope.activeModule) {
                case 1:
                    for (let transaction in this.scope.LBLCUSModule.transactionStatus) {
                        let value = this.scope.LBLCUSModule.transactionStatus[transaction];
                        if (value == true) {
                            isLoading = true;
                            break;
                        }
        ...
        */
        ...
        private loadLBLCUSList(): void {
            this.scope.loadingData = true;
            this.scope.LBLCUSModule.transactionStatus.LBLCUSList = true;
            this.scope.LBLCUSModule.LBLCUSRecord.PK01 = "";
            this.appService.lstLBLCUSRecords().then((val: M3.IMIResponse) => {

                let filteredVal = this.filterLBLCUS("LBLCUS", val);
                this.scope.LBLCUSModule.LBLCUSList = filteredVal;
                this.scope.LBLCUSModule.LBLCUSListGrid.data = filteredVal;//val.items; //added after adding the list

                this.gridService.adjustGridHeight("LBLCUSListGrid", filteredVal.length, 1000) //added to adjust grid height
                this.scope.LBLCUSModule.transactionStatus.LBLCUSList = false;
                this.refreshTransactionStatus();
            }, (err: M3.IMIResponse) => {
                this.scope.LBLCUSModule.transactionStatus.LBLCUSList = false;
                this.refreshTransactionStatus();
        ...
        private filterLBLCUS(fileName: string, val: M3.IMIResponse): any {
        ...
        private loadLBLCUSRecord(fieldName: string, selectedRow): void {

            this.scope.loadingData = true;
            this.scope.LBLCUSModule.transactionStatus.LBLCUSRecord = true;
            this.appService.getLBLCUSAlphaRecord(selectedRow.PK01, selectedRow.PK02, selectedRow.PK03).then((val: M3.IMIResponse) => {
                let rcid = val.items[0].PK01;
                switch (rcid) {
                    case "1":
                        this.scope.LBLCUSModule.rcid = "Internal";

                        break;
                    case "2":
                        this.scope.LBLCUSModule.rcid = "Customer";
                        break;
                    case "3":
                        this.scope.LBLCUSModule.rcid = "Origin";
                        break;
                    case "4":
                        this.scope.LBLCUSModule.rcid = "Expiry";
                        break;
                }
                this.scope.LBLCUSModule.LBLCUSRecord = val.items[0];
            ...
            this.appService.getLBLCUSNumericRecord(selectedRow.PK01, selectedRow.PK02, selectedRow.PK03).then((valNumeric: M3.IMIResponse) => {
                ...
                this.scope.LBLCUSModule.LBLCUSRecord.N096 = n096;
                this.scope.LBLCUSModule.LBLCUSRecord.N196 = n196;
                this.scope.LBLCUSModule.LBLCUSRecord.N396 = n396;
                this.scope.LBLCUSModule.LBLCUSRecord.N296 = parseInt(valNumeric.item.N296);
                this.scope.LBLCUSModule.LBLCUSRecord.N496 = parseInt(valNumeric.item.N496);
                this.scope.LBLCUSModule.LBLCUSRecord.N596 = parseInt(valNumeric.item.N596);
                this.scope.LBLCUSModule.LBLCUSRecord.N696 = parseInt(valNumeric.item.N696);
                this.scope.LBLCUSModule.LBLCUSRecord.N796 = parseInt(valNumeric.item.N796);
                this.scope.LBLCUSModule.LBLCUSRecord.N896 = parseInt(valNumeric.item.N896);
                this.scope.LBLCUSModule.LBLCUSRecord.N996 = parseInt(valNumeric.item.N996);
        ...
        public saveLBLCUSRecord(): void {

            // Needed keys
            let pk01 = this.scope.LBLCUSModule.LBLCUSRecord.PK01;
            let pk02 = this.scope.LBLCUSModule.LBLCUSRecord.PK02;
            let pk03 = this.scope.LBLCUSModule.LBLCUSRecord.PK03;

            // alpha fileds to save 
            let al30 = this.scope.LBLCUSModule.LBLCUSRecord.AL30;
            let al31 = this.scope.LBLCUSModule.LBLCUSRecord.AL31;
            let al32 = this.scope.LBLCUSModule.LBLCUSRecord.AL32;
            let al33 = this.scope.LBLCUSModule.LBLCUSRecord.AL33;
            let al34 = this.scope.LBLCUSModule.LBLCUSRecord.AL34;
            let al35 = this.scope.LBLCUSModule.LBLCUSRecord.AL35;
            let al36 = this.scope.LBLCUSModule.LBLCUSRecord.AL36;
            //NUMERIC
            let n096 = this.scope.LBLCUSModule.LBLCUSRecord.N096;
            let n196 = this.scope.LBLCUSModule.LBLCUSRecord.N196;
            let n296 = this.scope.LBLCUSModule.LBLCUSRecord.N296;
            let n396 = this.scope.LBLCUSModule.LBLCUSRecord.N396;
            let n496 = this.scope.LBLCUSModule.LBLCUSRecord.N496;
            let n596 = this.scope.LBLCUSModule.LBLCUSRecord.N596;
            let n696 = this.scope.LBLCUSModule.LBLCUSRecord.N696;
            let n796 = this.scope.LBLCUSModule.LBLCUSRecord.N796;
            let n896 = this.scope.LBLCUSModule.LBLCUSRecord.N896;
            let n996 = this.scope.LBLCUSModule.LBLCUSRecord.N996;
            n096 = (n096 === true) ? 1 : 0;
            n196 = (n196 === true) ? 1 : 0;
            n396 = (n396 === true) ? 1 : 0;
            ...
            if (this.isValid() === false) {
                ...
                this.appService.saveLBLCUSAlphaRecord(pk01, pk02, pk03, al30, al31, al32, al33, al34, al35, al36).then((val: M3.IMIResponse) => {
                    this.appService.saveLBLCUSNumericRecord(pk01, pk02, pk03, n096, n196, n296, n396, n496, n596, n696, n796, n896, n996).then((valNumerc: M3.IMIResponse) => {
        ...
        private openWindow() {
            ...
            // get record
            let selectedLBLCUSTable = this.scope.LBLCUSModule.LBLCUSRecord.PK01;
            this.scope.loadingData = true;
            ...
            if (selectedLBLCUSTable == undefined) {
                ...
                this.appService.getAlphaLBLCUSRecord(selectedLBLCUSTable).then((val: M3.IMIResponse) => {
                    //get record
                    ...
                    this.refreshTransactionStatus();
                    // let error = "API: " + err.program + "." + err.transaction + ", Input: " + JSON.stringify(err.requestData) + ", Error Code: " + err.errorCode;
                    let error = selectedLBLCUSTable + " Does not exist";
                    this.showError(error, [err.errorMessage]);
                    this.scope.statusBar.push({ message: error + " " + err.errorMessage, statusBarMessageType: h5.application.MessageType.Error, timestamp: new Date() });
        ...
        private openAppManager() {
            let selectedLBLCUSTable = "ZSYTAB";
            let pathString = "";
            let server = "";
            let port = "";
            let folderPath = "";
        ...
        public displayDialog() {
            ...
            let r = confirm("Are you sure you want to delete the format " + this.scope.LBLCUSModule.LBLCUSRecord.PK02 +"?");
            if (r == true) {
                this.deleteRecord();
            }
        ...
        public addRecord(): void {
            ...
            if (pk01 == "" || pk01 == null) {
                ...
                this.appService.addLBLCUSAlphaRecord(pk01, pk02, pk03, al30, al31, al32, al33, al34, al35, al36).then((val: M3.IMIResponse) => {

                    this.appService.addLBLCUSNumeric(pk01, pk02, pk03, n096, n196, n296, n396, n496, n596, n696, n796, n896, n996).then((valNumerc: M3.IMIResponse) => {
        ...
        public deleteRecord(): void {
            this.scope.LBLCUSModule.transactionStatus.LBLCUSRecord = true;
            // Needed keys
            let pk01 = this.scope.LBLCUSModule.LBLCUSRecord.PK01;//constant

            let pk02 = this.scope.LBLCUSModule.LBLCUSRecord.PK02;
            let pk03 = this.scope.LBLCUSModule.LBLCUSRecord.PK03;
            this.appService.deleteLBLCUSAlphaRecord(pk01, pk02, pk03).then((val: M3.IMIResponse) => {
                this.loadLBLCUSList();
                this.closeModalWindow();
                this.scope.LBLCUSModule.transactionStatus.LBLCUSRecord = false;
                this.refreshTransactionStatus();
            ...
            //delete numeric
            this.appService.deleteLBLCUSNumericRecord(pk01, pk02, pk03).then((val: M3.IMIResponse) => {
                this.loadLBLCUSList();
                this.closeModalWindow();
                this.scope.LBLCUSModule.transactionStatus.LBLCUSRecord = false;
                this.refreshTransactionStatus();
        ...
        public openAddRecordwindow(): void {
            let keyVal = this.scope.LBLCUSModule.LBLCUSRecord.PK02;
        ...
        */
        private loadLBLCUSModule(reLoad: boolean): void {
            let userContext = this.scope.userContext;
        ...
        private openLBLCUSAddRecordModal(): void { //POPUP
            let options: any = {
                animation: true,
        ...
        private LBLCUSListRowSelected(selectedRow: any) {
