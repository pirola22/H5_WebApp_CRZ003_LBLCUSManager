        ...
        var AppController = (function () {
            ...
            AppController.prototype.initAppScope = function () {
                ...
                this.scope.views = {
                    ...
                    LBLCUSModule: { url: "views/LBLCUSModule.html" },
                    errorModule: { url: "views/Error.html" },
                };
                this.scope.modules = [
                    { moduleId: 1, activeIcon: 'SampleModule1.png', inactiveIcon: 'SampleModule1-na.png', heading: 'Label Type Module', content: this.scope.views.LBLCUSModule.url, active: true, available: true },
                ];
                this.scope.appConfig = {};
                this.scope.userContext = new M3.UserContext();
                this.scope["dateRef"] = new Date();
                this.initGlobalSelection();
                this.initLBLCUSModule();
            };
            AppController.prototype.initGlobalSelection = function () {
                this.scope.globalSelection = {
                    reload: true,
                    transactionStatus: {
                        LBLCUSTableList: false,
                    },
                    division: {},
                };
            };
            AppController.prototype.initLBLCUSModule = function () {
                this.scope.LBLCUSModule = {
                    reload: true,
                    transactionStatus: {
                        LBLCUSList: false,
                        LBLCUSRecord: false,
                    ...
                    LBLCUSList: {},
                    LBLCUSListGrid: {},
                    selectedLBLCUSListRow: {},
                    LBLCUSRecord: {},
                    loadLBLCUSRecordModule: {},
                    rcid: ""
                };
                this.loadLBLCUSList();
            };
            ...
            AppController.prototype.initScopeFunctions = function () {
                var _this = this;
                this.scope.LBLCUSModule.loadLBLCUSRecordModule = function (fieldName, rowEntity) { _this.displayDetailScreen(fieldName, rowEntity); };
            };
            AppController.prototype.initUIGrids = function () {
                this.scope.LBLCUSModule.LBLCUSListGrid = this.gridService.getLBLCUSListGrid();
                this.initUIGridsOnRegisterApi();
            };
            AppController.prototype.initUIGridsOnRegisterApi = function () {
                var _this = this;
                this.scope.LBLCUSModule.LBLCUSListGrid.onRegisterApi = function (gridApi) {
                    _this.gridService.adjustGridHeight("LBLCUSListGrid", _this.scope.LBLCUSModule.LBLCUSListGrid.data.length, 500);
                    gridApi.core.on.renderingComplete(_this.scope, function (handler) { _this.gridService.restoreGridState("LBLCUSListGrid", gridApi); });
                    gridApi.core.on.sortChanged(_this.scope, function (handler) { _this.gridService.saveGridState("LBLCUSListGrid", gridApi); });
                    gridApi.core.on.columnVisibilityChanged(_this.scope, function (handler) { _this.gridService.saveGridState("LBLCUSListGrid", gridApi); });
                    gridApi.core.on.filterChanged(_this.scope, function (handler) { _this.gridService.saveGridState("LBLCUSListGrid", gridApi); });
                    gridApi.colMovable.on.columnPositionChanged(_this.scope, function (handler) { _this.gridService.saveGridState("LBLCUSListGrid", gridApi); });
                    gridApi.colResizable.on.columnSizeChanged(_this.scope, function (handler) { _this.gridService.saveGridState("LBLCUSListGrid", gridApi); });
                    ...
                    gridApi.selection.on.rowSelectionChanged(_this.scope, function (row) {
                        _this.gridService.saveGridState("LBLCUSListGrid", gridApi);
                        _this.LBLCUSListRowSelected(row);
                    });
            ...
            AppController.prototype.closeModalWindow = function () {
                this.scope.LBLCUSModule.LBLCUSRecord.PK02 = "";
            ...
            AppController.prototype.loadApplicationData = function () {
                var categories = ['globalSelection', 'LBLCUSModule', 'customerMasterModule', 'LBLCUSModule'];
            ...
            AppController.prototype.clearData = function (categories) {
                ...
                categories.forEach(function (category) {
                    ...
                    if (category == "LBLCUSModule") {
                        _this.scope.LBLCUSModule.LBLCUSList = [];
                    }
                });
            };
            AppController.prototype.resetReloadStatus = function () {
                this.scope.LBLCUSModule.reload = true;
            };
            ...
            AppController.prototype.loadData = function (activeModule) {
                ...
                switch (activeModule) {
                    case 1:
                        this.loadLBLCUSModule(this.scope.LBLCUSModule.reload);
                        break;
                    case 2:
                        break;
                    case 3:
            ...
            AppController.prototype.refreshTransactionStatus = function () {
                ...
                switch (this.scope.activeModule) {
                    case 1:
                        for (var transaction in this.scope.LBLCUSModule.transactionStatus) {
                            var value = this.scope.LBLCUSModule.transactionStatus[transaction];
                            if (value == true) {
                                isLoading = true;
                                break;
                            }
            ...
            AppController.prototype.loadLBLCUSList = function () {
                var _this = this;
                this.scope.loadingData = true;
                this.scope.LBLCUSModule.transactionStatus.LBLCUSList = true;
                this.scope.LBLCUSModule.LBLCUSRecord.PK01 = "";
                this.appService.lstLBLCUSRecords().then(function (val) {
                    var filteredVal = _this.filterLBLCUS("LBLCUS", val);
                    _this.scope.LBLCUSModule.LBLCUSList = filteredVal;
                    _this.scope.LBLCUSModule.LBLCUSListGrid.data = filteredVal;
                    _this.gridService.adjustGridHeight("LBLCUSListGrid", filteredVal.length, 1000);
                    _this.scope.LBLCUSModule.transactionStatus.LBLCUSList = false;
                    _this.refreshTransactionStatus();
                }, function (err) {
                    _this.scope.LBLCUSModule.transactionStatus.LBLCUSList = false;
                    _this.refreshTransactionStatus();
            ...
            AppController.prototype.filterLBLCUS = function (fileName, val) {
                var filteredValues = [];
            ...
            AppController.prototype.displayDetailScreen = function (fieldName, selectedRow) {
                this.loadLBLCUSRecord(fieldName, selectedRow);
                this.openRecordDetailModal(fieldName, selectedRow);
            };
            AppController.prototype.loadLBLCUSRecord = function (fieldName, selectedRow) {
                var _this = this;
                this.scope.loadingData = true;
                this.scope.LBLCUSModule.transactionStatus.LBLCUSRecord = true;
                this.appService.getLBLCUSAlphaRecord(selectedRow.PK01, selectedRow.PK02, selectedRow.PK03).then(function (val) {
                    var rcid = val.items[0].PK01;
                    switch (rcid) {
                        case "1":
                            _this.scope.LBLCUSModule.rcid = "Internal";
                            break;
                        case "2":
                            _this.scope.LBLCUSModule.rcid = "Customer";
                            break;
                        case "3":
                            _this.scope.LBLCUSModule.rcid = "Origin";
                            break;
                        case "4":
                            _this.scope.LBLCUSModule.rcid = "Expiry";
                            break;
                    }
                    _this.scope.LBLCUSModule.LBLCUSRecord = val.items[0];
                    _this.scope.LBLCUSModule.transactionStatus.LBLCUSRecord = false;
                    _this.refreshTransactionStatus();
                }, function (err) {
                    _this.scope.LBLCUSModule.transactionStatus.LBLCUSRecord = false;
                    _this.refreshTransactionStatus();
                ...
                this.appService.getLBLCUSNumericRecord(selectedRow.PK01, selectedRow.PK02, selectedRow.PK03).then(function (valNumeric) {
                    ...
                    _this.scope.LBLCUSModule.LBLCUSRecord.N096 = n096;
                    _this.scope.LBLCUSModule.LBLCUSRecord.N196 = n196;
                    _this.scope.LBLCUSModule.LBLCUSRecord.N396 = n396;
                    _this.scope.LBLCUSModule.LBLCUSRecord.N296 = parseInt(valNumeric.item.N296);
                    _this.scope.LBLCUSModule.LBLCUSRecord.N496 = parseInt(valNumeric.item.N496);
                    _this.scope.LBLCUSModule.LBLCUSRecord.N596 = parseInt(valNumeric.item.N596);
                    _this.scope.LBLCUSModule.LBLCUSRecord.N696 = parseInt(valNumeric.item.N696);
                    _this.scope.LBLCUSModule.LBLCUSRecord.N796 = parseInt(valNumeric.item.N796);
                    _this.scope.LBLCUSModule.LBLCUSRecord.N896 = parseInt(valNumeric.item.N896);
                    _this.scope.LBLCUSModule.LBLCUSRecord.N996 = parseInt(valNumeric.item.N996);
                    _this.scope.LBLCUSModule.transactionStatus.LBLCUSRecord = false;
                    _this.refreshTransactionStatus();
                }, function (err) {
                    _this.scope.LBLCUSModule.transactionStatus.LBLCUSRecord = false;
            ...
            AppController.prototype.saveLBLCUSRecord = function () {
                var _this = this;
                var pk01 = this.scope.LBLCUSModule.LBLCUSRecord.PK01;
                var pk02 = this.scope.LBLCUSModule.LBLCUSRecord.PK02;
                var pk03 = this.scope.LBLCUSModule.LBLCUSRecord.PK03;
                var al30 = this.scope.LBLCUSModule.LBLCUSRecord.AL30;
                var al31 = this.scope.LBLCUSModule.LBLCUSRecord.AL31;
                var al32 = this.scope.LBLCUSModule.LBLCUSRecord.AL32;
                var al33 = this.scope.LBLCUSModule.LBLCUSRecord.AL33;
                var al34 = this.scope.LBLCUSModule.LBLCUSRecord.AL34;
                var al35 = this.scope.LBLCUSModule.LBLCUSRecord.AL35;
                var al36 = this.scope.LBLCUSModule.LBLCUSRecord.AL36;
                var n096 = this.scope.LBLCUSModule.LBLCUSRecord.N096;
                var n196 = this.scope.LBLCUSModule.LBLCUSRecord.N196;
                var n296 = this.scope.LBLCUSModule.LBLCUSRecord.N296;
                var n396 = this.scope.LBLCUSModule.LBLCUSRecord.N396;
                var n496 = this.scope.LBLCUSModule.LBLCUSRecord.N496;
                var n596 = this.scope.LBLCUSModule.LBLCUSRecord.N596;
                var n696 = this.scope.LBLCUSModule.LBLCUSRecord.N696;
                var n796 = this.scope.LBLCUSModule.LBLCUSRecord.N796;
                var n896 = this.scope.LBLCUSModule.LBLCUSRecord.N896;
                var n996 = this.scope.LBLCUSModule.LBLCUSRecord.N996;
                n096 = (n096 === true) ? 1 : 0;
                n196 = (n196 === true) ? 1 : 0;
                n396 = (n396 === true) ? 1 : 0;
                if (this.isValid() === false) {
                    ...
                    this.appService.saveLBLCUSAlphaRecord(pk01, pk02, pk03, al30, al31, al32, al33, al34, al35, al36).then(function (val) {
                        _this.appService.saveLBLCUSNumericRecord(pk01, pk02, pk03, n096, n196, n296, n396, n496, n596, n696, n796, n896, n996).then(function (valNumerc) {
                        }, function (err) {
                        });
                        _this.loadLBLCUSList();
                        _this.refreshTransactionStatus();
                        _this.closeModalWindow();
                        _this.scope.LBLCUSModule.transactionStatus.LBLCUSRecord = false;
                    }, function (err) {
            ...
            AppController.prototype.myError = function (err) {
                this.scope.LBLCUSModule.transactionStatus.LBLCUSRecord = false;
                this.refreshTransactionStatus();
                var error = "API: " + err.program + "." + err.transaction + ", Input: " + JSON.stringify(err.requestData) + ", Error Code: " + err.errorCode;
            ...
            AppController.prototype.openWindow = function () {
                ...
                var folderPath = "";
                var appName = "";
                var selectedLBLCUSTable = this.scope.LBLCUSModule.LBLCUSRecord.PK01;
                this.scope.loadingData = true;
                if (selectedLBLCUSTable == undefined) {
                    this.showError("Please select a Table Name.", null);
                    this.scope.loadingData = false;
                }
                else {
                    this.appService.getAlphaLBLCUSRecord(selectedLBLCUSTable).then(function (val) {
                        ...
                        _this.refreshTransactionStatus();
                        var error = selectedLBLCUSTable + " Does not exist";
                        _this.showError(error, [err.errorMessage]);
                        _this.scope.statusBar.push({ message: error + " " + err.errorMessage, statusBarMessageType: h5.application.MessageType.Error, timestamp: new Date() });
                    }).finally(function () {
                        _this.scope.loadingData = false;
            ...
            AppController.prototype.openAppManager = function () {
                var _this = this;
                var selectedLBLCUSTable = "ZSYTAB";
                var pathString = "";
                var server = "";
                var port = "";
                var folderPath = "";
            ...
            AppController.prototype.displayDialog = function () {
                var r = confirm("Are you sure you want to delete the format " + this.scope.LBLCUSModule.LBLCUSRecord.PK02 + "?");
                if (r == true) {
                    this.deleteRecord();
                }
            };
            AppController.prototype.addRecord = function () {
                ...
                if (pk01 == "" || pk01 == null) {
                    ...
                    this.appService.addLBLCUSAlphaRecord(pk01, pk02, pk03, al30, al31, al32, al33, al34, al35, al36).then(function (val) {
                        _this.appService.addLBLCUSNumeric(pk01, pk02, pk03, n096, n196, n296, n396, n496, n596, n696, n796, n896, n996).then(function (valNumerc) {
                        }, function (err) {
                            _this.myError(err);
                        });
                        _this.loadLBLCUSList();
            ...
            AppController.prototype.deleteRecord = function () {
                ...
                var pk02 = this.scope.LBLCUSModule.LBLCUSRecord.PK02;
                var pk03 = this.scope.LBLCUSModule.LBLCUSRecord.PK03;
                this.appService.deleteLBLCUSAlphaRecord(pk01, pk02, pk03).then(function (val) {
                    _this.loadLBLCUSList();
                    _this.closeModalWindow();
                    _this.scope.LBLCUSModule.transactionStatus.LBLCUSRecord = false;
                    _this.refreshTransactionStatus();
                ...
                this.appService.deleteLBLCUSNumericRecord(pk01, pk02, pk03).then(function (val) {
                    _this.loadLBLCUSList();
                    _this.closeModalWindow();
                    _this.scope.LBLCUSModule.transactionStatus.LBLCUSRecord = false;
                    _this.refreshTransactionStatus();
            ...
            AppController.prototype.openAddRecordwindow = function () {
                var keyVal = this.scope.LBLCUSModule.LBLCUSRecord.PK02;
                this.scope.LBLCUSModule.LBLCUSRecord.PK02 = keyVal;
                if (keyVal == "" || keyVal == null || keyVal == 0) {
                    var error = "Table name must be entered";
                    this.showError(error, [error]);
                }
                else {
                    this.scope.LBLCUSModule.LBLCUSRecord.KPID = "LBLCUS";
                    this.scope.LBLCUSModule.LBLCUSRecord.PK01 = "1";
                    this.scope.LBLCUSModule.LBLCUSRecord.PK02 = keyVal;
                    this.scope.LBLCUSModule.LBLCUSRecord.PK03 = "";
                    this.scope.LBLCUSModule.LBLCUSRecord.AL30 = "";
                    this.scope.LBLCUSModule.LBLCUSRecord.AL31 = "";
                    this.scope.LBLCUSModule.LBLCUSRecord.AL32 = "";
                    this.scope.LBLCUSModule.LBLCUSRecord.AL33 = "";
                    this.scope.LBLCUSModule.LBLCUSRecord.AL34 = "";
                    this.scope.LBLCUSModule.LBLCUSRecord.AL35 = "";
                    this.scope.LBLCUSModule.LBLCUSRecord.AL36 = "";
                    this.scope.LBLCUSModule.LBLCUSRecord.N096 = 0;
                    this.scope.LBLCUSModule.LBLCUSRecord.N196 = 0;
                    this.scope.LBLCUSModule.LBLCUSRecord.N296 = 0;
                    this.scope.LBLCUSModule.LBLCUSRecord.N396 = 0;
                    this.scope.LBLCUSModule.LBLCUSRecord.N496 = 0;
                    this.scope.LBLCUSModule.LBLCUSRecord.N596 = 0;
                    this.scope.LBLCUSModule.LBLCUSRecord.N696 = 0;
                    this.scope.LBLCUSModule.LBLCUSRecord.N796 = 0;
                    this.scope.LBLCUSModule.LBLCUSRecord.N896 = 0;
                    this.scope.LBLCUSModule.LBLCUSRecord.N996 = 0;
                    this.openLBLCUSAddRecordModal();
                }
            };
            AppController.prototype.loadLBLCUSModule = function (reLoad) {
                var userContext = this.scope.userContext;
                if (reLoad) {
                    this.clearData(["LBLCUSModule"]);
                    this.loadLBLCUSList();
                }
                this.scope.LBLCUSModule.reload = false;
            };
            AppController.prototype.openRecordDetailModal = function (fieldName, rowEntity) {
                var options = {
                    animation: true,
                    templateUrl: "views/LBLCUSRecordDetail.html",
                    size: "lg",
                    scope: this.scope,
                    backdrop: "static"
                };
                this.scope.modalWindow = this.$uibModal.open(options);
                this.scope.LBLCUSModule.selectedLBLCUSListRow = rowEntity;
            };
            AppController.prototype.openLBLCUSAddRecordModal = function () {
                var options = {
                    animation: true,
                    templateUrl: "views/AddLBLCUSRecordModal.html",
                    size: "lg",
                    scope: this.scope,
                    backdrop: "static"
                };
            ...
            AppController.prototype.LBLCUSListRowSelected = function (selectedRow) {
                this.scope.LBLCUSModule.selectedLBLCUSListRow = selectedRow.entity;
            };
