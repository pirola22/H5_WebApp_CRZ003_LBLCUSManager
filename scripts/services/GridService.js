    ...
    (function (application) {
        var GridService = (function () {
            ...
            GridService.prototype.clearGridStates = function () {
                var _this = this;
                var gridIds = ["sampleGrid1", "LBLCUSListGrid", "customerMasterListGrid", "itemGroupListGrid"];
            ...
            GridService.prototype.getLBLCUSListGrid = function () {
                var LBLCUSListGrid = angular.copy(this.baseGrid);
                var gridLinkCellTemplate = "<div class=\"ui-grid-cell-contents\" title=\" {{COL_FIELD }}\"><span class=\"h5-link\" ng-click=\"grid.appScope.LBLCUSModule.loadLBLCUSRecordModule(col.field, row.entity)\">{{COL_FIELD CUSTOM_FILTERS}}</span></div>";
                LBLCUSListGrid.columnDefs = [
                    { name: "PK02", displayName: this.languageService.languageConstants.get('Format'), cellTemplate: gridLinkCellTemplate, enableCellEdit: false },
                    ...
                    { name: "PK03", displayName: this.languageService.languageConstants.get('Mode'), headerCellClass: "text-left", cellClass: "text-left", enableCellEdit: false },
                ];
                LBLCUSListGrid.exporterCsvFilename = "sample_list.csv";
                LBLCUSListGrid.exporterPdfFilename = "sample_list.pdf";
                LBLCUSListGrid.saveSelection = false;
                return LBLCUSListGrid;
            };
