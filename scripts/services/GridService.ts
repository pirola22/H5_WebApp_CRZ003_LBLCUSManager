module h5.application {
    ...
    export class GridService {
        ...
        public clearGridStates() {
            let gridIds = ["sampleGrid1", "LBLCUSListGrid", "customerMasterListGrid", "itemGroupListGrid"]; //added
        ...
        public getLBLCUSListGrid(): IUIGrid {
            let LBLCUSListGrid: IUIGrid = angular.copy(this.baseGrid);
            //let gridLinkCellTemplate = "<div class=\"ui-grid-cell-contents\" title=\" {{COL_FIELD }}\"><span class=\"h5-link\" ng-click=\"grid.appScope.LBLCUSModule.loadLBLCUSRecordModule(col.field, row.entity)>{{COL_FIELD CUSTOM_FILTERS}}</span></div>";
           let gridLinkCellTemplate = "<div class=\"ui-grid-cell-contents\" title=\" {{COL_FIELD }}\"><span class=\"h5-link\" ng-click=\"grid.appScope.LBLCUSModule.loadLBLCUSRecordModule(col.field, row.entity)\">{{COL_FIELD CUSTOM_FILTERS}}</span></div>";
